...
console.log(`V16.6 Armory render isolation verified: rich local hover restored, stable memo inputs, lightweight catalog art, max ${maxMounted}/210 desktop tiles mounted.`);
