...
need(js,'/* Riftbound Armory Portrait Restoration V16.8 */','V16.8 portrait-restoration marker');
need(css,'/* Riftbound Armory Render Isolation V16.6 */','V16.6 style marker');
need(js,'children:[(0,E.jsx)(RIFT_ITEM_ICON,{item,size:`small`,pulse})','authored catalog portrait renderer');
...
if(js.includes('RIFT_V166_CATALOG_ICON'))throw new Error('Armory still contains the V16.6 silhouette-only catalog renderer');
...
console.log(`Armory verified: authored catalog portraits restored, rich local hover preserved, required shared symbols present, stable memo inputs, max ${maxMounted}/210 desktop tiles mounted.`);
