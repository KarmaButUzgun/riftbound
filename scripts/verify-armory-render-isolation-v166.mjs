...
const tileStart=js.indexOf('function RIFT_V16_CATALOG_TILE(');
const tileEnd=js.indexOf('const RIFT_V16_CATALOG_TILE_MEMO=',tileStart);
if(tileStart<0||tileEnd<0)throw new Error('Armory catalog tile scope missing');
const tile=js.slice(tileStart,tileEnd);
need(tile,'RIFT_V166_CATALOG_ICON','catalog tile silhouette path');
if(tile.includes('RIFT_ITEM_ICON'))throw new Error('catalog tile regressed to full authored portrait renderer');
