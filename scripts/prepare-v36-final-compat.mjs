...
await patch('scripts/verify-reference-lore-v6.mjs',[
 ...
 [`assert.ok(refs.includes('Deltarune')&&refs.includes('Umbrella Academy')&&refs.includes('Devil May Cry')&&refs.includes('Dragon Ball')&&refs.includes('Jujutsu')&&refs.includes('All For One'), 'reference coverage should include the named inspirations');`,`assert.ok(refs.includes('Deltarune')&&refs.includes('Umbrella Academy')&&refs.includes('Devil May Cry')&&refs.includes('Dragon Ball')&&refs.includes('Jujutsu')&&refs.includes('All For One'), 'reference coverage should include the named inspirations');`],
