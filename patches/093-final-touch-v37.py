...
'''
bundle=once(bundle,catalog_anchor,starter_items+catalog_anchor,'starter item catalog insertion')
...
compat=root.parent.parent/'scripts'/'prepare-v35-verifier-compat.mjs'
# During normal builds `root` points at .build/riftbound-standalone, so repository scripts live at cwd/scripts.
