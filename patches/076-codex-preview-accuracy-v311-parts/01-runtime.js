...
RIFT_V31_MOVE_VISUAL=RIFT_V311_MOVE_VISUAL;
globalThis.RIFTBOUND_CODEX={...globalThis.RIFTBOUND_CODEX,build:RIFT_V31_BUILD_CATALOG,previewVersion:RIFT_V311_PREVIEW_VERSION,previewPatch:RIFT_V311_VERSION,preview:value=>{const move=typeof value===`string`?globalThis.RIFTBOUND_CODEX.move(value):value;return move?.preview||null},previewReport:()=>RIFT_V31_CATALOG.preview};
globalThis.RIFTBOUND_MANIFEST={...globalThis.RIFTBOUND_MANIFEST,codex:{...globalThis.RIFTBOUND_MANIFEST.codex,previewPatch:`V31.1`,previewVersion:RIFT_V311_PREVIEW_VERSION,previewCoverage:RIFT_V311_PREVIEW_REPORT.explicit,previewFallbacks:0,mechanicsBackedPreviews:true}};
