...
if text.count(anchor)==1:
    ...
    print('Extended canonical V6 reference lore with V36 Dark items before freeze.')
else:
    print('V36 reference lore: historical registry spelling is opaque; preserving explicit item lore without mutating frozen V6 table.')
