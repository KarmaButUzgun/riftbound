...
print('Applied V37.1 frozen-copy/preview-token hotfix: V36.8 copy registry stays immutable, Boogie Woogie receives authored V37 copy through the live lookup layer, and swap is registered as an explicit Codex preview token.')
